...
urlpatterns = [
     ...
     path('visited/<int:id>/', visited_resto, name='visited_resto'),
     path('notvisited/<int:id>/', not_visited_resto, name='not_visited_resto'),
     path('deletewishlist/<int:id>/', delete_wishlist, name='delete_wishlist'),
